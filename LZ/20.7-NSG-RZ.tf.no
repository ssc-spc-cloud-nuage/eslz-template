...
resource "azurerm_network_watcher_flow_log" "Network-Project_RZ-flow" {
  ...
  network_security_group_id = azurerm_network_security_group.Project_RZ-nsg.id
  storage_account_id        = azurerm_storage_account.Project_law-sa.id
  enabled                   = true
  ...
  traffic_analytics {
    enabled               = true
    workspace_id          = azurerm_log_analytics_workspace.Project-law.workspace_id
    workspace_region      = azurerm_log_analytics_workspace.Project-law.location
